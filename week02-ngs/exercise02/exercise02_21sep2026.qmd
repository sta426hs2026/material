...
Please use this .qmd file as template to write your code and generate a formatted report in html.
Do also visualize your results. The report should contain these visualizations.
Avoid outputting large vectors, matrices or dataframes as plaint text.
Do push the .qmd and the .html file to the repository.
...
plot(density(x[, 1]), xlim=c(0, 1e5), main="", xlab="counts")
plot(density(log2(x[, 1] + 1)), main="", xlab="log2p1 of counts", xlim=c(1, log2(1e5)))
